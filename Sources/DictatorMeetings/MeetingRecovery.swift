...
/// every launch, in `MeetingsAppState.bootstrap` after the synced path is set and
...
enum MeetingRecovery {
    ...
    @discardableResult
    static func recoverInterrupted(settings: MeetingsSettings) -> [UUID] {
    ...
    private static func recoverOne(id: UUID, settings: MeetingsSettings) -> Bool {
