...
enum MeetingCoachReportService {
    ...
    static func generateReport(
        ...
        guard let engine = settings.activeLLMEngine() else { throw ReportError.llmDisabled }
        ...
        coach.reportModelID = MeetingSummaryService.engineModelID(settings: settings)
        return coach
    }
    ...
    private static func resolveRubric(meta: MeetingMeta, settings: DictatorSettings) -> String? {
