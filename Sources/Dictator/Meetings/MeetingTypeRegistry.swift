...
enum MeetingTypeRegistry {
    ...
    static func all(settings: DictatorSettings) -> [MeetingTypeDefinition] {
    ...
    static func definition(for id: MeetingTypeID, settings: DictatorSettings) -> MeetingTypeDefinition {
    ...
    static func displayName(for id: MeetingTypeID, settings: DictatorSettings) -> String {
    ...
    static func detectionCandidates(settings: DictatorSettings) -> [MeetingTypeDefinition] {
