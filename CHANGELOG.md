...
- AM/PM markers now always come out without dots. Whisper sometimes transcribes the marker as "A.M." or "p.m." with periods; Dictator now strips them so the output is consistently "AM" / "PM" / "am" / "pm" depending on the case the speaker used.
