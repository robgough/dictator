...
- AM/PM markers in transcribed times now always come out as lowercase "am" / "pm" without dots, regardless of how Whisper rendered the marker on the utterance ("A.M." / "p.m." / "PM" all normalise to "am" / "pm"). "o'clock" also normalises to lowercase.
